                ...
                <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="px-8 py-6 space-y-4">
                        ...
                        <button
                            ...
                            disabled={registrationsOpen === false}
                            className="w-full flex items-center justify-center gap-3 bg-slate-900 hover:bg-black text-white font-bold py-3 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        ...
                        <button
                            ...
                            disabled={registrationsOpen === false}
                            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 text-slate-700 font-bold py-3 rounded-xl transition-all border border-slate-200 hover:border-slate-300 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        ...
                        <button
                            ...
                            disabled={registrationsOpen === false}
                            className="w-full flex items-center justify-center gap-3 bg-[#0052CC] hover:bg-[#0747A6] text-white font-bold py-3 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
